...
function getCottageMascardiImagesPaths() {
	const mainImages = Object.values(
		import.meta.glob(
			"@assets/cottages/cottage-mascardi/main-images/*.webp",
			{
				eager: true,
				query: "?url",
				import: "default",
	...
	const thumbnails = Object.values(
		import.meta.glob(
			"@assets/cottages/cottage-mascardi/thumbnails/*.webp",
			{
				eager: true,
				query: "?url",
				import: "default",
...
function getCottageCatedralImagesPaths() {
	const mainImages = Object.values(
		import.meta.glob(
			"@assets/cottages/cottage-catedral/main-images/*.webp",
			{
				eager: true,
				query: "?url",
				import: "default",
	...
	const thumbnails = Object.values(
		import.meta.glob(
			"@assets/cottages/cottage-catedral/thumbnails/*.webp",
			{
				eager: true,
				query: "?url",
				import: "default",
